<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="showId" label="关联公告编号id"></el-table-column>
...
export default {
  ...
  methods:{
    ...
    load(){
      ...
      this.request.get("http://localhost:9090/showcomment/page",{
        params:{
    ...
    delBatch(){
      ...
      console.log(ids)
      this.request.post("http://localhost:9090/showcomment/del/batch", ids).then(res => {
        if (res) {
