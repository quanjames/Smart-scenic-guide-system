<template>
  <div >
    <div style=" padding-left:10px; margin: 10px 0">
      <el-input size="small" style="width: 300px" placeholder="请输入景点名称" suffix-icon="el-icon-search" v-model="touristname"></el-input>
    ...
    <div class="card" v-for="data in localData" >
      <img class="card-image" :src="data.iconUrl" />
      <div class="card-body">
        <h5 class="card-title" >{{data.touristname}}</h5>

        <div class="card-content">

          <div  @click="speak(data.description)" >
            <img src="../../assets/voice.png"  style="width: 30px; position: relative; top: 5px; right: 0">:{{data.description}}</div>
